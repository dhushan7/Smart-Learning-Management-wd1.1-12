...
export default function EditProfile() {
  ...
  useEffect(() => {
    ...
    // Secure GET profile using authorization headers
    axios
            ...
            <div className="col-span-2 p-8 space-y-8">
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <input
                  ...
                  className="w-full mb-4 p-3 bg-gray-50 border border-gray-200 rounded-lg animate-none"
                />
